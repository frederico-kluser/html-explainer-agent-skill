 ...
 * o install.sh instala a skill como SYMLINK do diretório html-explainer-agent-skill/ inteiro
 * (~/.claude/skills/html-explainer-agent-skill -> repo/html-explainer-agent-skill). O loader ESM do Node resolve
